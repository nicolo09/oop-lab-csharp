...
namespace ExtensionMethods
{
    ...
    public static class ComplexExtensions
    {
        ...
        {
            return new Complex((c1.Real * c2.Real + c1.Imaginary * c2.Imaginary) / (Math.Pow(c2.Real, 2) + Math.Pow(c2.Imaginary, 2)), (c1.Imaginary * c2.Real - c1.Real * c2.Imaginary) / (Math.Pow(c2.Real, 2) + Math.Pow(c2.Imaginary, 2)));
        }
        ...
        {
            return new Complex(1,0).Divide(c1);
        }
    }
}
